...
if __name__ == '__main__':
    ...
    if len(sys.argv) not in [2, 3]:
        ...
        if lib.DEBUG:
            ...
            lib.find_vertical_spread(underline_ticker, put_option_chains, days_to_expiry, True)
            call_option_chains = option_chain_data.call_data
            lib.find_vertical_spread(underline_ticker, call_option_chains, days_to_expiry, False)
            ...
            lib.find_strangle(underline_ticker, option_chain_data_all, days_to_expiry)
            ...
            lib.find_strangle(underline_ticker, underline_price, option_chain_data_all, days_to_expiry)
